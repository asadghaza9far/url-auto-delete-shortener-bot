...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('⚡ 🇵​​🇷​​🇴​ ​🇲​​🇴​​🇻​​🇮​​🇪​​🇸​ ​🇫​​🇮​​🇳​​🇩​​🇪​​🇷 ⚡', url='https://t.me/promoviesfind')
            ],
            [
                InlineKeyboardButton('⚡ 🇦​​🇱​​🇱​ ​🇲​​🇴​​🇻​​🇮​​🇪​​🇸​ ​🇫​​🇮​​🇳​​🇩​​🇪​​🇷​ ​🇬​​🇷​​🇴​​🇺​​🇵​ ⚡', url=f"https://t.me/movies94group"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ SUBSCᏒIBΞ ⚡', url='https://t.me/mkvhuboffical'),
            InlineKeyboardButton('🤖 UᎮDΛTΞS 🤖', url='https://t.me/movies94group')
            ],[
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ SUBSCᏒIBΞ ⚡', url='https://t.me/MKVHUBMOVIESBOT'),
            InlineKeyboardButton('🤖 🇵​​🇷​​🇴​ ​🇲​​🇴​​🇻​​🇮​​🇪​​🇸​ ​🇫​​🇮​​🇳​​🇩​​🇪​​🇷 🤖', url='https://t.me/promoviesfind')
            ],[
            InlineKeyboardButton('♻️ HΞLᎮ ♻️', callback_data='help'),
            InlineKeyboardButton('♻️ ΛBOUT ♻️', callback_data='about')
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('ᴀʟʟ ᴍᴏᴠɪᴇꜱ ꜰɪɴᴅᴇʀ ɢʀᴏᴜᴘ', url='https://t.me/movies94group') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
